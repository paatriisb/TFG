          ...
          <div className="col-md-6 col-lg-4">
            <div className="card-servicio shadow">
              ...
              <div className="card-servicio-body">
                <ul>
                  <li>
                    <strong>Psicóloga:</strong> Marta López
                  </li>
                  <li>
                    <strong>Teléfono:</strong> 600-111-222
                  </li>
                  <li>
                    <strong>Email:</strong> mlopez@clinica.com
                  </li>
                  <li>
                    <strong>Ubicación:</strong> Calle Pepa, 13, Madrid
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card-servicio shadow">
              ...
              <div className="card-servicio-body">
                <ul>
                  <li>
                    <strong>Psicólogo:</strong> Carlos Ruiz
                  </li>
                  <li>
                    <strong>Teléfono:</strong> 655-222-333
                  </li>
                  <li>
                    <strong>Email:</strong> cruiz@apoyo.es
                  </li>
                  <li>
                    <strong>Ubicación:</strong> Av. Libertad, 45, Madrid
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-md-6 col-lg-4">
            <div className="card-servicio shadow">
              ...
              <div className="card-servicio-body">
                <ul>
                  <li>
                    <strong>Psicóloga:</strong> Elena Sanz
                  </li>
                  <li>
                    <strong>Teléfono:</strong> 677-444-555
                  </li>
                  <li>
                    <strong>Email:</strong> esanz@bienestar.com
                  </li>
                  <li>
                    <strong>Ubicación:</strong> Calle Mayor, 10, Madrid
                  </li>
                </ul>
              </div>
            </div>
