...
const Emergencia = () => {
  ...
  const [posicionChica, setPosicionChica] = useState<[number, number] | null>(null);
  ...
  // CERRAR SESIÓN POR INACTIVIDAD ABSOLUTA (1 MINUTO)
  useEffect(() => {
    let timeout: number;
    ...
    const resetTimer = () => {
      ...
      timeout = window.setTimeout(() => {
        logout();
      }, 60000); // 1 MINUTO DE TIEMPO LÍMITE
    };
  ...
  const dibujarMapaPatrulla = async () => {
    ...
    try {
      ...
      let marcador = L.marker(coordinates[0], { icon: iconoPolicia }).addTo(map);
        ...
        if (i < coordinates.length - 1) {
          ...
          const argumentoSuaveCoche = setInterval(() => {
            if (contadorTramo >= pasosPorTramo) {
              ...
              const lat = puntoInicio[0] + (puntoDestino[0] - puntoInicio[0]) * progreso;
              const lng = puntoInicio[1] + (puntoDestino[1] - puntoInicio[1]) * progreso;
              ...
              <div className="contenedor-mapa-mujer mt-4 shadow-sm w-100">
                ...
                <div className="text-center mt-3">
                  ...
                  <p className="small mb-0">
                    La patrulla está en camino. Por favor, rellena el cuestionario.
                  </p>
                </div>
              </div>
            )}
                  ...
                  {numPregunta < preguntas.length - 1 ? (
                    ...
                    <>
                      ...
                      <p className="small text-muted mb-4">
                        Por favor, introduce los datos exactos que el GPS no puede detectar (Piso, puerta, letra, bloque) antes del paso final.
                      </p>
                    ...
                    <>
                      ...
                      <div className="d-flex gap-3">
                        ...
                        <button
                          className="btn btn-outline-dark btn-lg flex-fill py-3 fs-4 fw-bold btn-no-gris"
                          onClick={() => {
                            Swal.fire("Protocolo", "No se ha activado la patrulla de seguimiento.", "info");
                          }}
                        >
                          NO
                        </button>
        ...
        <div className="container text-center text-md-start">
          <div className="row text-center text-md-start">
            <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
              <h5 className="text-uppercase mb-4 fw-bold titulosDelFooter">Ayuda</h5>
              <p className="small">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-5 col-lg-4 text-center text-md-end">
              <p className="small">
                Diseñado con <i className="bi bi-heart-fill text-danger"></i> por la comunidad.
              </p>
            </div>
          </div>
        </div>
